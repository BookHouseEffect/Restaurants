...
namespace Restaurants.API.Migrations
{
    ...
    [Migration("20170904070832_Employee_Restaurant_relationship_set_to_Nullable")]
    partial class Employee_Restaurant_relationship_set_to_Nullable
    {
            ...
            modelBuilder.Entity("Restaurants.API.Models.EntityFramework.LocationContact", b =>
                {
                    ...
                    b.HasOne("Restaurants.API.Models.EntityFramework.RestaurantObjects", "TheRestaurantOwningTheSchedule")
                        .WithOne("TheRestaurantLocationAddress")
                        .HasForeignKey("Restaurants.API.Models.EntityFramework.LocationContact", "RestaurantId");
                });
            ...
            modelBuilder.Entity("Restaurants.API.Models.EntityFramework.Menus", b =>
                {
                    ...
                    b.HasOne("Restaurants.API.Models.EntityFramework.RestaurantObjects", "TheRestaurantOwningTheMenu")
                        .WithOne("TheRestaurantMenu")
                        .HasForeignKey("Restaurants.API.Models.EntityFramework.Menus", "RestaurantId");
                });
